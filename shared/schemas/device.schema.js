...
exports.validateDeviceRecord = validateDeviceRecord;
function validateDeviceRecord(device) {
    ...
    if (!d.model)
        errors.push("Missing device model");
    if (!d.status)
        errors.push("Missing device status");
    if (!d.health || typeof d.health !== "object")
        errors.push("Missing device health object");
