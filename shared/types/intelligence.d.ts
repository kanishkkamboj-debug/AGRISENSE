...
export interface AgriculturalEvent {
    id: string;
    eventType: "RAIN_STARTED" | "RAIN_STOPPED" | "SOIL_DRYING" | "SOIL_WETTING" | "RAPID_DRYING" | "RAPID_WETTING" | "HEAT_EVENT" | "HUMIDITY_EVENT" | "WATERLOGGING_RISK" | "DROUGHT_STRESS" | "GAS_ANOMALY" | "SENSOR_FAILURE" | "DEVICE_OFFLINE" | "DEVICE_RECONNECTED" | "IRRIGATION_RESPONSE" | "UNEXPECTED_SENSOR_RESPONSE";
    startedAt: string;
    endedAt?: string;
...
export interface IoTIntelligenceReport {
    ...
    fieldId: string;
    timestamp: string;
    sensorAvailability: Record<string, {
        available: boolean;
        state: MeasurementState;
        quality: DataQuality;
        value: number | null;
